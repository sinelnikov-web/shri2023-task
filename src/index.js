...
function Header() {
    ...
    return <header className="header">
        <a href="/Users/sinelnikov-web/Public" className="header__logo" aria-label="Яндекс.Дом"></a>
        ...
        <ul className={'header__links' + (expanded ? ' header__links_opened' : '') + (toggled ? ' header__links-toggled' : '')}>
            <li className="header__item">
                <a className="header__link header__link_current" href="/Users/sinelnikov-web/Public" aria-current="page">Сводка</a>
            </li>
            <li className="header__item">
